...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        {/* Hero Section - Slider without text overlay */}
        <div className="relative">
          <ImageSlider />
        </div>

        {/* Hero Text Content - Moved outside of slider */}
        <div className="bg-primary text-white py-16 md:py-20 text-center px-4">
          <div className="container mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button 
                size="lg" 
                variant="secondary"
                className="bg-white hover:bg-gray-100 text-primary px-8 py-6 text-lg rounded-full shadow-lg transition-transform hover:scale-105"
                asChild
              >
                <Link to="/auth/login">
                  Get Started
        ...
        <div className="bg-primary text-white py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button 
              size="lg" 
              variant="secondary"
              className="bg-white text-primary hover:bg-gray-100 px-8 py-6 text-lg rounded-full shadow-lg transition-transform hover:scale-105"
              asChild
            >
              <Link to="/auth/login">
                Get Started Now
